...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'hhshhhs917')).split()]  # For Multiple Id Use One Space Between Each.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Filmydosesofficial) # Support Chat Link Without https:// or @
