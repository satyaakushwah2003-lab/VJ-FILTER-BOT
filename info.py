...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001950093576 -1002388939037 -1002366583266 -1002339055280 -1002181149561').split()]  # For Multiple Id Use One Space Between Each.
