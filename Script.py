...
class script(object):
    ...
    I am Satyaa The Movie Provider if you want something just type correct name with release year like Pushpa 2021</b>"""
...
<b>⚙️ sɪᴢᴇ : {file_size} ➠➠➠ BOT : @MOVIES24X7_BOT</b>""" 
